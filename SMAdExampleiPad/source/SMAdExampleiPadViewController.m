...
@implementation SMAdExampleiPadViewController

- (void) viewDidLoad {
	[super viewDidLoad];
	smad = [[SMAd alloc] init];
	config = [[NSMutableDictionary alloc] init];
	[SMAdConfig setBannerAreaId:@"IPAD_SAY_TEST_BANNER" forConfig:config];
	[SMAdConfig setInterstitialAreaId:@"IPAD_SAY_TEST_INTER" forConfig:config];
